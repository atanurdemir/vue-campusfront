<template>
  <div class="flex">
    <div class="w-1/4">
      ...
      <div class="text-xs text-center md:text-base">{{ steps[0] }}</div>
    </div>
    ...
    <div class="w-1/4">
        ...
        >
          ...
          >
            <div
              ...
              :style="`width: ${loadings[0]}%`"
            ></div>
          </div>
        </div>

        <div
          :class="`w-10 h-10 mx-auto rounded-full text-lg text-white flex items-center ${styles[0].svg}`"
        >
          <span :class="`text-center w-full ${styles[0].color}`">
            <svg
              class="w-full fill-current"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
      ...
      <div class="text-xs text-center md:text-base">{{ steps[1] }}</div>
    </div>
    ...
    <div class="w-1/4">
      <div class="relative mb-2">
        ...
        >
          ...
          >
            <div
              class="w-0 bg-green-300 py-1 rounded"
              :style="`width: ${loadings[1]}%`"
            />
          </div>
        </div>

        <div
          :class="`w-10 h-10 mx-auto rounded-full text-lg text-white flex items-center ${styles[1].svg}`"
        >
          <span :class="`text-center w-full ${styles[1].color}`">
            <svg
              class="w-full fill-current"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
      ...
      <div class="text-xs text-center md:text-base">{{ steps[2] }}</div>
    </div>
    ...
    <div class="w-1/4">
      <div class="relative mb-2">
        ...
        >
          ...
          >
            <div
              class="w-0 bg-green-300 py-1 rounded"
              :style="`width: ${loadings[2]}%`"
            />
          </div>
        </div>

        <div
          :class="`w-10 h-10 mx-auto rounded-full text-lg text-white flex items-center ${styles[2].svg}`"
        >
          <span :class="`text-center w-full ${styles[2].color}`">
            <svg
              class="w-full fill-current"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
      ...
      <div class="text-xs text-center md:text-base">{{ steps[3] }}</div>
    </div>
  </div>
</template>
...
export default {
  ...
  props: {
    ...
    loadings: { type: Array, required: true },
  },
  setup() {},
};
</script>
